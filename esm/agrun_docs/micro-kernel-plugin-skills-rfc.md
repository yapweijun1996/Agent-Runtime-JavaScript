...
> **Superseded (2026-06-09):** the default-skill/package-split direction was
> completed, but the kernel-seam hook/enforcement relocation described here was
> replaced by deletion. Current SSOT: ADR-0054 and
> `kernel-seam-removal-design.md`.
...
@agrun/skills-research  (opt-in plugin package)
  ...
  ├─ portable skills/tools and advisory workflow text
  └─ no kernel-seam runtime-hook enforcement (superseded by ADR-0054)
