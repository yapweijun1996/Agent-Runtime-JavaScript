# Prompt section: `compactPlannerDirectives`

Default content shipped by agrun.js. Source: `src/runtime/prompts/planner-compact-directives.js`.

Rendered for: envelope, compact mode (compactSystemPrompt=true). Override via `createRuntime({ prompts: { compactPlannerDirectives: ... } })` — see [feature-toggles](../feature-toggles.md#prompt-content-overrides-prompts).
