...
ADR-0012 is the controlling decision for long research:
...
- Runtime owns mechanism only: source authority scoring, duplicate detection,
  ...
  counters, and gate-signal envelopes.
...
- Runtime veto paths return structured gate signals. They must not synthesize
